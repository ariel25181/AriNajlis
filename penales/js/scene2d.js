...
function draw(){
  ...
  try{
    ...
    drawFigure(KICKER_SPOT.x*W, KICKER_SPOT.y*H, 1.25, '#F5D547', '#b8202c', 0);
...
function drawFigure(x, y, scale, jerseyColor, shortsColor, leanDeg){
  ctx.save();
  ctx.translate(x, y);
  ...
  ctx.shadowColor = jerseyColor; ctx.shadowBlur = 10;
  ctx.fillStyle = jerseyColor;
